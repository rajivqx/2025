        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <input type="hidden" class="url" value="<?php echo e(url('/students/'.$student->id)); ?>" >
                        <input type="hidden" class="rdt-url" value="<?php echo e(url('/students')); ?>" >
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-ajax\script\resources\views/edit.blade.php ENDPATH**/ ?>