                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($row->student_age); ?></td>
                                    <td>
                                        <?php if($row->student_gender == 'm'): ?>
                                            <?php echo e('Male'); ?>
                                    ...
                                    <td><a href="<?php echo e(url('students/'.$row->id.'/edit')); ?>" class="btn btn-dark">Edit</a></td>
                                    <td>
                                        <a href="javascript:void(0)" class="delete-student btn btn-danger" data-id="<?php echo e($row->id); ?>">Delete</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-ajax\script\resources\views/index.blade.php ENDPATH**/ ?>